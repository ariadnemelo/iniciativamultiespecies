...
if( $wp_query->have_posts() ):
	...
	echo '<table border="0" cellpadding="0" class="courses-table-list tablesorter">
			<thead>
			  <tr>
				<th class="courses-table-title-header" scope="col">'.esc_html__('Course Name', 'lms').'</th>
				<th class="courses-table-type-header" scope="col">'.esc_html__('Course Type', 'lms').'</th>
				<th class="courses-table-lessons-header" scope="col">'.esc_html__('Lessons #', 'lms').'</th>
				<th class="courses-table-cost-header" scope="col">'.esc_html__('Cost', 'lms').'</th>
				<th class="courses-table-length-header" scope="col">'.esc_html__('Length', 'lms').'</th>
			  </tr>
			</thead>
			<tbody>';
