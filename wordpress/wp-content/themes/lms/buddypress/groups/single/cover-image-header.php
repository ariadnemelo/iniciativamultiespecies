	...
	<div id="item-header-cover-image">
		...
		<div id="item-header-content">
			...
			<div id="item-meta">
				...
				<span class="activity"><?php printf( esc_html__( 'active %s', 'lms' ), bp_get_group_last_active() ); ?></span>
		...
		<div id="item-actions">
			...
			<?php if ( bp_group_is_visible() ) : ?>
				...
				<h3><?php esc_html_e( 'Group Admins', 'lms' ); ?></h3>
				...
				if ( bp_group_has_moderators() ) :
					...
					<h3><?php esc_html_e( 'Group Mods' , 'lms' ); ?></h3>
