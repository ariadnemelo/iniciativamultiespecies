							...
							<div class="entry-thumb">
                                ...
                                <?php if( $format === "image" || empty($format) ): ?>
                                        ...
                                        <?php if( has_post_thumbnail() ):
                                              ...
                                              elseif($pholder != 'on'):?>
                                                <img src="http<?php echo dttheme_ssl(); ?>://placehold.it/1170x822&text=<?php the_title(); ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
                                        <?php endif;?>
                                        </a>
							...
							<div class="entry-details">
								...
								<div class="entry-metadata">
									...
									<p class="<?php echo esc_attr( $hide_comment_meta );?> comments">
										<?php comments_popup_link( '<span class="fa fa-comments-o"> </span>'.esc_html__(' 0', 'lms'), '<span class="fa fa-comments-o"> </span>'.esc_html__(' 1', 'lms'), '<span class="fa fa-comments-o"> </span>'.esc_html__(' %', 'lms'),'', '<span class="fa fa-comments-o"> </span>'.esc_html__(' 0', 'lms'));?>
									</p>	
								</div><!--  .entry-metadata -->
