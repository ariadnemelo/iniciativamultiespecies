...
class MY_Flickr extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(false,IAMD_THEME_NAME.__(' Flickr Widget', 'lms'),$widget_options);
	}
	...
	function form($instance) {
        ...
        <p><label for="<?php echo $this->get_field_id('flickr_id'); ?>"><?php _e('Flickr ID:', 'lms');?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('How many entries do you want to show:', 'lms');?></label>
         ...
         <p><label for="<?php echo $this->get_field_id('show');?>"><?php _e('What pictures to display', 'lms'); ?></label>
         	<select class="widefat" id="<?php echo $this->get_field_id('show'); ?>" name="<?php echo $this->get_field_name('show'); ?>">
            <?php  $a = array("latest"=>__("Latest", 'lms'),"random"=>__("Random", 'lms'));
         ...
         <p><label for="<?php echo $this->get_field_id('size');?>"><?php _e('What pictures to display', 'lms'); ?></label>
         	<select class="widefat" id="<?php echo $this->get_field_id('size'); ?>" name="<?php echo $this->get_field_name('size'); ?>">
            <?php  $a = array("s"=>__("square", 'lms'),"t"=>__("thumbnail", 'lms'), "m" => __("medium", 'lms'));
			foreach($a as $key => $value ):
