...
$quizzcolumns = array(1 => 1, 2 => 2, 3 => 3);
...
$class_types = array('onsite' => 'Onsite', 'online' => 'Online');
...
$coursecolumns  = array(1 => '1 - List', 2 => '2 - List/Grid', 3 => '3 - Grid', 4 => '4 - Grid');
$classcolumns  = array(2 => '2', 3 => '3');
...
$options = array(
			...
			'animation' => array(
				'title' => esc_html__('Animation', 'dt_themes'),
				'type' => 'select',
				'options' => $dt_animation_types,
				'default_value' => array()
			),
			'animation_delay' => array(
				'title' => esc_html__('Animation Delay', 'dt_themes'),
				'type' => 'text',
				'default_value' => ''
			),
			'class' => array(
...
$dt_modules['general']['doshortcode_team'] = array(
	...
	'options' => array(
		'tf_content' => array(
			...
			'type' => 'wp_editor',
			'is_content' => true,
			'default_value' => '[dt_sc_team name="DesignThemes" role="Chief Programmer" image="https://placehold.it/500" type=" / type2" twitter="#" facebook="#" google="#" linkedin="#"]
...
$dt_modules['general']['testimonial'] = array(
	...
	'options' => array(
		...
		'image' => array(
			...
			'type' => 'upload',
			'default_value' => 'https://placehold.it/300'
		),
		'tm_content' => array(
			'title' => __('Content', 'dt_themes'),
			'type' => 'wp_editor',
...
$dt_modules['general']['clients_carousel'] = array(
	...
	'options' => array(
		'cc_content' => array(
			...
			'is_content' => true,
			'default_value' => '<ul>
									<li><a href="#"><img title="Client 1" src="https://placehold.it/163x116" alt="Client 1" /></a></li>
									<li><a href="#"><img title="Client 2" src="https://placehold.it/163x116" alt="Client 2" /></a></li>
									<li><a href="#"><img title="Client 3" src="https://placehold.it/163x116" alt="Client 3" /></a></li>
									<li><a href="#"><img title="Client 4" src="https://placehold.it/163x116" alt="Client 4" /></a></li>
									<li><a href="#"><img title="Client 5" src="https://placehold.it/163x116" alt="Client 5" /></a></li>
								</ul>'
		)
	)
);
...
if(dttheme_option('general', 'disable-theme-default-courses') != 'true') {
	...
	$dt_modules['unique']['classes'] = array(
		'name' => __('Classes', 'dt_themes'),
		'tooltip' => __('Use this module to add classes', 'dt_themes'),
		'icon_class' => 'ico-classes',
		'options' => array(
			'columns' => array(
				'title' => __('Columns', 'dt_themes'),
				'type' => 'select',
				'options' => $classcolumns,
				'default_value' => array(2)
			),
			'post_per_page' => array(
				'title' => __('Post Per Page', 'dt_themes'),
				'type' => 'text',
				'default_value' => '-1'
			),
			'disable_onsiteonline_filter' => array(
				'title' => __('Disable Onsite / Online Filter', 'dt_themes'),
				'type' => 'select',
				'options' => $trueorfalse,
				'default_value' => array()
			),
			'disable_popularfeatured_filter' => array(
				'title' => __('Disable Popular / Featured Filter', 'dt_themes'),
				'type' => 'select',
				'options' => $trueorfalse,
				'default_value' => array()
			),
			'disable_listgridview' => array(
				'title' => __('Disable List / Grid Filter', 'dt_themes'),
				'type' => 'select',
				'options' => $trueorfalse,
				'default_value' => array()
			),
	...
	$dt_modules['unique']['quizzes'] = array(
		'name' => __('Quizzes', 'dt_themes'),
		'tooltip' => __('Use this module to add quizzes', 'dt_themes'),
		'icon_class' => 'ico-quizzes',
		'options' => array(
			'columns' => array(
				'title' => __('Columns', 'dt_themes'),
				'type' => 'select',
				'options' => $quizzcolumns,
				'default_value' => array()
			),
			'quiz_ids' => array(
				'title' => __('Quiz Ids (Quiz ids separated by commas)', 'dt_themes'),
				'type' => 'text',
				'default_value' => ''
			),
		)
...
if( class_exists('Tribe__Events__Main') || class_exists('Tribe__Events__Pro__Main') ) {
	...
	$dt_modules['unique']['events'] = array(
		...
		'options' => array(
			...
			'category_ids' => array(
				'title' => esc_html__('Category Ids (separated by commas)', 'dt_themes'),
				'type' => 'text',
				'default_value' => ''
			),
		)
...
$dt_modules['unique']['teacher'] = array(
	...
	'tooltip' => sprintf(esc_html__('Use this module to add %s', 'dt_themes'), strtolower($GLOBALS['teachers-plural-label'])),
...
$dt_modules['unique']['subscription_form'] = array(
	...
	'options' => array(
		'image_url' => array(
			'title' => __('Image', 'dt_themes'),
			'type' => 'upload',
			'default_value' => 'https://placehold.it/780x502'
		),
		'slider' => array(
...
$dt_modules['others']['mobile'] = array(
	...
	'options' => array(
		'mobile' => array(
			...
			'type' => 'text',
			'default_value' => '+91 1234567890'
		),		
	)
);

$dt_modules['others']['whatsapp_no'] = array(
	'name' => __('Whatsapp', 'dt_themes'),
	'tooltip' => __('Use this module to add whatsapp number alone', 'dt_themes'),
	'icon_class' => 'ico-whatsapp',
	'options' => array(
		'text' => array(
			'title' => __('Whatsapp', 'dt_themes'),
			'type' => 'text',
			'default_value' => '+91 22222222222'
		),	
		'class' => array(
			'title'         => esc_html__('Class', 'dt_themes'),
			'type'          => 'text',
			'default_value' => 'fa fa-whatsapp'
		),	
	)
);
