(function(){
	...
	var teachers_label = DTCorePlugin.teachers_plural_label;
			...
			menu:[
				...
				{ text : 'Contact Info', menu :[
					...
					{ text: 'Mobile', onclick: function(e){
						e.stopPropagation();
						editor.insertContent('[dt_sc_mobile mobile="+91 1234567890"/]');
					}},

					{ text: 'Whatsapp', onclick: function(e){
						e.stopPropagation();
						editor.insertContent('[dt_sc_whatsapp_no text="+91 1234567890"/]');
					}},
				...
				
				{
					text: 'Classes',
					onclick: function(){
						editor.selection.setContent('[dt_sc_classes columns="2/3" post_per_page="-1" disable_onsiteonline_filter="true/false" disable_popularfeatured_filter="true/false" disable_listgridview="true/false" /]');
					}
				},
				...
				
				{
					text: 'Quizzes',
					onclick: function(){
						editor.selection.setContent('[dt_sc_quizzes quiz_ids="1,2,3" columns="1/2/3" /]');
					}
				},
					...
					menu:[
						{
							...
							onclick:function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_h1 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h1]');
							}
						},

						{
							...
							onclick:function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_h2 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h2]');
							}
						},
						{
							text:'H3',
							onclick:function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_h3 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h3]');
							}
						},
						{
							text:'H4',
							onclick:function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_h4 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h4]');
							}
						},
						{
							text:'H5',
							onclick:function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_h5 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h5]');
							}
						},
						{
							text:'H6',
							onclick:function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_h6 type=" / type2"]Lorem ipsum dolor sit amet[/dt_sc_h6]');
							}
						},
					]
				},
				...
				{ text:'Others',
					menu:[
						...
						{ text:'Team',
							onclick: function(e){
								e.stopPropagation();
								editor.insertContent('[dt_sc_team name="DesignThemes" role="Chief Programmer" image="http://placehold.it/500" type=" / type2" twitter="#" facebook="#" google="#" linkedin="#"]<br><p>Saleem naijar kaasram eerie can be disbursed in the wofl like of a fox that is her thing smaoasa lase lemedds laasd pamade eleifend sapien.</p>[/dt_sc_team]');
							}
						},
