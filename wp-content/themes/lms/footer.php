        ...
        <footer id="footer">
            ...
            if(!is_page_template('tpl-demopage.php')) {
                ...
                <div class="footer-logo">  
                        ...
                        ?>
                        <img class="normal_logo" src="<?php echo esc_url($flogo);?>" alt="<?php esc_attr_e('Footer Logo', 'lms');?>" title="<?php esc_attr_e('Footer Logo', 'lms');?>">
...
<?php
	if (is_singular() AND comments_open())
        ...
        if( dttheme_option('integration', 'enable-body-code') ):
            add_action( 'wp_footer', 'dttheme_footer_add_inline_script' );
            function dttheme_footer_add_inline_script() {
                $custom_js = stripslashes(dttheme_option('integration', 'body-code'));
                wp_add_inline_script( 'jquery-nicescroll', $custom_js, 'after' );
            }
        endif;
