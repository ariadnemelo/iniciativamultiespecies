...
var mythemeAdmin = {
  ...
  adminPanelTab : function(){
   ...
   var wp_version = objectL10n.mysiteWpVersion;
    if($tab.length) {
		if( wp_version>='3.6') {
			$tab.tabs({ show:500  });
		} else {
  ...
  mediaUpload: function(){
    ...
    window.tb_remove = function() {
      var wp_version = objectL10n.mysiteWpVersion;
      if(header_clicked && wp_version>='3.3') {
  ...
  widgetAdd: function(){
   jQuery('.mytheme_add_widgetarea').on('click',function(e){
  ...
  menuAdd : function(){
    "use strict";
    jQuery('.mytheme_add_item').on('click',function(e){
      var $this = jQuery(this).parent().next(),
  ...
  jQuery('.mytheme_add_group_item').on('click',function(e){
      var $this = jQuery(this).parent().next(),
          $appendTo = $this.find('.menu-to-edit'),
          $itemToClone = $this.find('.sample-to-edit li'),
          $item = $appendTo.find('li'),
    ...
    jQuery('.mytheme_add_tab_item').on('click',function(e){
      var $this = jQuery(this).parent().next(),
          $appendTo = $this.find('.menu-to-edit'),
          $itemToClone = $this.find('.sample-to-edit li'),
          $item = $appendTo.find('li'),
  ...
  adminOptionSave: function(){
    "use strict";
    jQuery('.mytheme-footer-submit').on('click',function(e){
  ...
  colorPicker: function(){
    "use strict";
    var wp_version = objectL10n.mysiteWpVersion;
	if(parseFloat(wp_version) >= parseFloat("3.5")){
  ...
  resetConfirm : function (){
    "use strict";
    jQuery('.mytheme-reset-button').on('click',function(e){
    	e.preventDefault();
		...
		$ptemplate_select.live('change', function(){
			...
			switch($val){
				...
				case 'tpl-courses.php':
					...
					$ptemplate_box.find('h2').text('Courses Options');
					$ptemplate_box.slideDown();
					$ptemplate_box.find('#tpl-breadcrumbsection-settings').slideDown();
					$ptemplate_box.find('#tpl-common-settings').slideDown();
				...
				case 'tpl-classes.php':
					...
					$ptemplate_box.find('h2').text('Classes Options');
					$ptemplate_box.slideDown();
					$ptemplate_box.find('#tpl-breadcrumbsection-settings').slideDown();
					$ptemplate_box.find('#tpl-common-settings').slideDown();
				...
				case 'tpl-fullwidth.php':
					$ptemplate_box.find('h2').text('Fullwidth Page Options');
					$ptemplate_box.slideDown();
					$ptemplate_box.find('#tpl-breadcrumbsection-settings').slideDown();
					$ptemplate_box.find('#tpl-common-settings').slideDown();
				...
				case 'tpl-landingpage.php':
					$ptemplate_box.find('h2').text('Default Options');
					$ptemplate_box.slideDown();
					$ptemplate_box.find('#tpl-breadcrumbsection-settings').slideDown();
  ...
  backupOption: function(){
	  jQuery("a#mytheme_backup_button").on('click',function(e){
  ...
  restoreOption : function(){
	  jQuery("a#mytheme_restore_button").on('click',function(e){
  ...
  importOption : function() {
	  jQuery("a#mytheme_import_button").on('click',function(e){
  ...
  changeTemplate() {
    ...
    switch($val){
      ...
      case 'default':
        ...
        $ptemplate_box.find('#tpl-blog').slideUp();
        $ptemplate_box.find('#tpl-portfolio').slideUp();
        $ptemplate_box.find('#tpl-courses').slideUp();
        $ptemplate_box.find('#tpl-classes').slideUp();
        $ptemplate_box.find('#tpl-breadcrumbsection-settings').slideDown();
        $ptemplate_box.find('#tpl-common-settings').slideDown();
        $ptemplate_box.find('#tpl-default-settings').slideDown();
        $ptemplate_box.find('#custom-style-settings').slideDown();
