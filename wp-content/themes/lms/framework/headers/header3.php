                ...
                <div class="container">
                    <div id="logo">
                        ...
                        if( dttheme_option('general', 'logo') ):
                            ...
                            <a href="<?php echo esc_url(home_url('/'));?>" title="<?php echo dttheme_blog_title();?>">
                            ...
                            <h2><a href="<?php echo esc_url(home_url('/'));?>" title="<?php echo dttheme_blog_title();?>"><?php echo do_shortcode(get_option('blogname')); ?></a></h2><?php
                        endif;?>
                    ...
                    <div class="contact-details">
                        ...
                        <p class="mail"> <span class="fa fa-envelope-o"> </span> <a href="mailto:<?php echo "{$email}";?>"><?php echo esc_html( $email );?></a> </p>
                            ...
                            if( is_page_template('tpl-landingpage.php') ) {
                                ...
                                if (function_exists('wp_nav_menu')) :
                                    $primaryMenu = wp_nav_menu(array(
                                                ...
                                                'menu_id'=>'',
                                                'menu_class'=>'menu',
                                                'fallback_cb'=>'dttheme_default_navigation_alt',
                                                'echo'=>false,
                                                'container'=>false,
