...
<section id="primary" class="content-full-width">
    ...
    <div id="<?php echo esc_attr( $section_name_lp ); ?>" class="landing-page-home">
        <?php
        global $post;
        ...
        <div class="landing-page-content">
            ...
            <div class="container">
            	<?php
				wp_link_pages(array('before' => '<div class="page-link"><strong>'.esc_html__('Pages:', 'lms').'</strong> ', 'after' => '</div>', 'next_or_number' => 'number'));
				edit_post_link(esc_html__( ' Edit ', 'lms' ),'','',$post->ID);
				?>
            </div>
        </div>
    </div>
    ...
    if( $sections_query->have_posts() ):
        while( $sections_query->have_posts() ):
            ...
            <div id="<?php echo esc_attr( $section_name );?>" class="landing-page">
