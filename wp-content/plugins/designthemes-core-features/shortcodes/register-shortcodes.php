...
if (! class_exists ( 'DTCoreShortcodes' )) {
	...
	class DTCoreShortcodes {
		...
		function dt_init() {
			...
			wp_enqueue_style ( 'dt-sc-timepicker-addon-css', plugin_dir_url ( __FILE__ ) . 'css/jquery-ui-timepicker-addon.css' );
			...
			if (! is_admin ()) {
				...
				wp_enqueue_script ( 'dt-sc-plugin-scripts', plugin_dir_url ( __FILE__ ) . 'js/jsscplugins.js', array(), false, true);
		...
		function dt_admin_init() {
			...
			wp_localize_script ( 'jquery', 'DTCorePlugin', array (
					...
					'teachers_plural_label' => $GLOBALS['teachers-plural-label'] 
			) );
		}
		...
		function dt_the_content_filter($content) {
			$dt_shortcodes = array("dt_sc_accordion_group","dt_sc_button","dt_sc_blockquote","dt_sc_callout_box","dt_sc_one_half","dt_sc_one_third","dt_sc_one_fourth","dt_sc_one_fifth","dt_sc_one_sixth",
				...
				"dt_sc_five_sixth_inner","dt_sc_four_fifth_inner","dt_sc_address","dt_sc_phone","dt_sc_mobile","dt_sc_whatsapp_no","dt_sc_fax","dt_sc_email","dt_sc_web"
				...
				"dt_sc_subscription_form","dt_sc_subscribed_courses","dt_sc_newsletter_section","dt_sc_slider_search","dt_sc_widgets","dt_sc_doshortcode",
				"dt_sc_resizable","dt_sc_resizable_inner","dt_sc_classes","dt_sc_quizzes");
