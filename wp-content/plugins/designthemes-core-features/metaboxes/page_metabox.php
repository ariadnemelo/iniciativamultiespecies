<?php 
    ...
    function page_metabox(){
        add_meta_box("page-template-slider-meta-container", __('Slider Options', 'lms'), "page_sllider_settings", "page", "normal", "default"); 
        add_meta_box("page-template-meta-container", __('Default page Options', 'lms'), "page_settings", "page", "normal", "default");
    ...
    function page_sllider_settings($args){  
        ...
        <div class="custom-box">
            <div class="column one-sixth">
                <label><?php _e('Show Slider', 'lms');?> </label>
            </div>
            <div class="column four-sixth last">
                ...
                <p class="note"> <?php _e('YES! to show slider on this page.', 'lms');?> </p>
            </div>
        </div><!-- Show Slider End-->
        ...
        <div class="custom-box">
            ...
            <div class="column four-sixth last">
                <?php $slider_types = array( '' => __("Select", 'lms'),
                                             'layerslider' => __("Layer Slider", 'lms'),
                                             'revolutionslider' => __("Revolution Responsive", 'lms'),
                                             'imageonly' => __( "Image Only", 'lms') );
                      ...
                      endforeach;
                     echo "</select>";?>
            <p class="note"> <?php _e("Choose which slider you wish to use ( eg: Layer or Revolution )", 'lms');?> </p>
            </div>
        ...
        <?php $layerslider = $revolutionslider = $imageonly = 'style="display:none"';
              ...
              <div id="layerslider" class="custom-box" <?php echo $layerslider;?>>
                ...
                <?php if( class_exists( 'LS_Sliders' ) ):
                      ...
                      if($sliders != null && !empty($sliders)):
                            ...
                            echo '  <label>'.__('Select LayerSlider', 'lms').'</label>';
                            echo '  </div>';
                            echo ' <div class="column two-sixth">';
                            echo '  <select name="layerslider_id">';
                            echo '      <option value="0">'.__("Select Slider", 'lms').'</option>';
                                        foreach($sliders as $item) :
                                            $id = $item['id'];
                                            $name = $item['name'];
                                            $name = empty( $name ) ? esc_html__("Unnamed", "lms" ) : $name;
                            ...
                            echo '  </select>';
                            echo '<p class="note">';
                            _e("Choose Which LayerSlider you would like to use..", 'lms');
                            echo "</p>";
                            echo '  </div>';
                            echo '  </div>';
                            echo '</div>';
                      else:
                         echo '<p id="j-no-images-container">'.__('Please add atleat one layer slider', 'lms').'</p>';
                      endif;
                    else : ?>
                        <p id="j-no-images-container"><?php _e('Please activate Layer Slider , and add at least one slider.', 'lms'); ?></p><?php
                    endif;?>                
              </div><!-- Layered Slider End-->

              <!-- Revolution Slider -->
              <div id="revolutionslider" class="custom-box" <?php echo $revolutionslider;?>>
                <h3><?php _e('Revolution Slider', 'lms');?></h3>
                <?php $return = dttheme_check_slider_revolution_responsive_wordpress_plugin();
                      if($return):
                        echo '<div class="one-half-content">';
                        echo '  <div class="bpanel-option-set">';
                        echo ' <div class="column one-sixth">';
                        echo '  <label>'.__('Select Slider', 'lms').'</label>';
                        echo '</div>';
                        ...
                        echo '</select>';
                        echo '<p class="note">';
                        _e("Choose which Revolution slider would you like to use!", 'lms');
                        echo "</p>";
                        echo '</div>';
                        echo '  </div>';
                        echo '</div>';
                      else: ?>
                        <p id="j-no-images-container"><?php _e('Please activate Revolution Slider , and add at least one slider.', 'lms'); ?></p>
                <?php endif;?>
            ...
            <div id="imageonly" <?php echo $imageonly;?>>
                ...
                <div class="custom-box">
                    <div class="column one-sixth"><?php _e( 'Choose Image', 'lms');?></div>
                    <div class="column five-sixth last">
                        <div class="image-preview-container">
                            ...
                            <input type="button" value="<?php _e('Upload', 'lms');?>" class="upload_image_button show_preview" />
                            <input type="button" value="<?php _e('Remove', 'lms');?>" class="upload_image_reset" />
                            <?php if( !empty($slider_image) ) dttheme_adminpanel_image_preview($slider_image );?>
                            <p class="note"><?php _e("Upload an image instead of slider", 'lms');?></p>
                        </div>    
                    </div>
                </div>
                
                <div class="custom-box">
                    <div class="column one-sixth"><?php _e( 'Content', 'lms');?></div>
                    <div class="column five-sixth last">
                        ...
                        <p class="three-fourth note"> <?php _e('You can add shortcode here to display it along with image', 'lms');?> </p>
                    </div>
                </div>
    ...
    function page_settings($args){
        ...
        <div class="j-pagetemplate-container">
            ...
            <div id="tpl-breadcrumbsection-settings">
                ...
                <div class="custom-box">
                    <div class="column one-sixth">
                        <label><?php _e('Disable Breadcrumb Section', 'lms');?> </label>
                    </div>
                    <div class="column four-sixth last">
                        ...
                        <p class="note"> <?php _e('YES! to disable breadcrumb section completely in this page.', 'lms');?> </p>
                    </div>
            ...
            <div id="tpl-common-settings">
                ...
                <div id="page-layout" class="custom-box">
                    <div class="column one-sixth"><label><?php _e('Layout', 'lms');?> </label></div>
                    <div class="column five-sixth last">
                        <ul class="bpanel-layout-set"><?php 
                         ...
                         <p class="note"> <?php _e("You can choose between a left, right or no sidebar layout.", 'lms');?> </p>
                    </div>
                 </div> <!-- Layout End-->
                ...
                <div id="widget-area-options" <?php echo $sidebar_both;?>>
                    ...
                    <div id="left-sidebar-container" class="page-left-sidebar" <?php echo $sidebar_left; ?>>
                        ...
                        <div id="page-commom-sidebar" class="sidebar-section custom-box">
                            <div class="column one-sixth"><label><?php _e('Disable Every Where Sidebar Left', 'lms');?></label></div>
                            <div class="column five-sixth last"><?php 
                                ...
                                <p class="note"> <?php _e('Yes! to hide "Every Where Sidebar" on this page.', 'lms');?> </p>
                             </div>
                        ...
                        <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
                            <div class="column one-sixth"><label><?php _e('Choose Widget Area - Left Sidebar', 'lms');?></label></div>
                            <div class="column five-sixth last"><?php
                                if( array_key_exists('widget-area-left', $tpl_default_settings)):
                                    ...
                                    $widgetareas = !empty($widgetareas) ? $widgetareas : array();
                    ...
                    <div id="right-sidebar-container" class="page-right-sidebar" <?php echo $sidebar_right; ?>>
                        ...
                        <div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
                            <div class="column one-sixth"><label><?php _e('Disable Every Where Sidebar Right', 'lms');?></label></div>
                            <div class="column five-sixth last"><?php 
                        ...
                        <!-- 3. Choose Widget Areas Start -->
                        <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
                            <div class="column one-sixth"><label><?php _e('Choose Widget Area - Right Sidebar', 'lms');?></label></div>
                            <div class="column five-sixth last"><?php
            ...
            <div id="tpl-default-settings">
                <!-- 4. Allow Commenet -->
                <div class="custom-box">
                    <div class="column one-sixth"><label><?php _e('Allow Comments', 'lms');?></label></div>
                    <div class="column five-sixth last"><?php 
                        ...
                        <p class="note"> <?php _e('YES! to allow comments on this page.', 'lms');?> </p>
                    </div>
            ...
            <div id="tpl-blog">
                ...
                <!-- Post Playout -->
                <div class="custom-box">
                    <div class="column one-sixth"><label><?php _e('Posts Layout', 'lms');?> </label></div>
                    
                    <div class="column five-sixth last">
                        <ul class="bpanel-post-layout bpanel-layout-set"><?php 
                            $posts_layout = array(  
                                'post-thumb' => __("Post Thumb", 'lms'),
                                'one-column'=>  __("Single post per row.", 'lms'),
                                'one-half-column'=> __("Two posts per row.", 'lms'),
                                'one-third-column'=>    __("Three posts per row.", 'lms'));
                        ...
                        <p class="note"> <?php _e("Choose layout style for your Blog", 'lms');?> </p>
                    </div>
                </div><!-- Post Playout End-->

                <!-- Allow Excerpt -->
                <div class="custom-box">
                    <div class="column one-sixth"><label><?php _e('Allow Excerpt', 'lms');?></label></div>
                    <div class="column five-sixth last">                     
                        ...
                        <p class="note"> <?php _e('Enable Excerpt', 'lms');?> </p>
                    </div>
                </div><!-- Allow Excerpt End-->

                <!-- Excerpt Length-->
                <div class="custom-box">
                    <div class="column one-sixth"><label><?php _e('Excerpt Length', 'lms');?></label></div>
                    <div class="column five-sixth last">
                        ...
                        <p class="note"> <?php _e("Limit! Number of charectors from the content to appear on each blog post (Number Only)", 'lms');?> </p>
                    </div>
                </div><!-- Excerpt Length End-->

                <!-- Post Count-->
                <div class="custom-box">
                    <div class="column one-sixth"><label><?php _e('Post per page', 'lms');?></label></div>
                    <div class="column five-sixth last">
                        <select name="mytheme-blog-post-per-page">
                            <option value="-1"><?php _e("All", 'lms');?></option>
                        ...
                        <p class="note"><?php _e("Your blog pages show at most selected number of posts per page.", 'lms');?></p>
                    </div>
                </div><!-- Post Count End-->
                
                <!-- Post Meta-->
                <div class="custom-box">
                    <h3><?php _e('Post Meta Options', 'lms');?></h3>
                    <?php $post_meta = array(array(
                                "id"=>      "disable-author-info",
                                "label"=>   __("Disable the Author info.", 'lms'),
                                "tooltip"=> __("By default the author info will display when viewing your posts. You can choose to disable it here.", 'lms')
                            ), array(
                                "id"=>      "disable-date-info",
                                "label"=>   __("Disable the date info.", 'lms'),
                                "tooltip"=> __("By default the date info will display when viewing your posts. You can choose to disable it here.", 'lms')
                            ),
                            array(
                                "id"=>      "disable-comment-info",
                                "label"=>   __("Disable the comment", 'lms'),
                                "tooltip"=> __("By default the comment will display when viewing your posts. You can choose to disable it here.", 'lms')
                            ),
                            array(
                                "id"=>      "disable-category-info",
                                "label"=>   __("Disable the category", 'lms'),
                                "tooltip"=> __("By default the category will display when viewing your posts. You can choose to disable it here.", 'lms')
                            ),
                            array(
                                "id"=>      "disable-tag-info",
                                "label"=>   __("Disable the tag", 'lms'),
                                "tooltip"=> __("By default the tag will display when viewing your posts. You can choose to disable it here.", 'lms')
                            ));
                        $count = 1;
                ...
                <!-- Categories -->
                <div class="custom-box">
                    <h3><?php _e('Exclude Categories', 'lms');?></h3>
                    ...
                    <p class="note"> <?php _e("You can choose certain categories to exclude from your blog page.", 'lms');?> </p>
                </div><!-- Categories End-->
             ...
             <div id="tpl-portfolio">
                ...
                <div class="custom-box">
                    <div class="column one-sixth">                 
                        <label><?php _e('Posts Layout', 'lms');?> </label>
                    </div>
                    <div class="column five-sixth last">       
                        ...
                        <?php $posts_layout = array( 
                                ...
                                'one-half-column'=> __("Two posts per row.", 'lms'),
                                'one-third-column'=>    __("Three posts per row.", 'lms'),
                                'one-fourth-column' => __("Four Posts per row", 'lms'));
                        ...
                        <p class="note"> <?php _e("Choose layout style for your Portfolio", 'lms');?> </p>
                    </div>      
                ...
                <div class="custom-box">
                    <div class="column one-sixth">                
                        <label><?php _e('Allow Grid Space', 'lms');?></label>
                    </div>
                    <div class="column five-sixth last">                       
                        ...
                        <p class="note"> <?php _e('Allow Grid Space for portfolio items', 'lms');?> </p>
                    </div>
                </div>
                ...
                <div class="custom-box">
                    <div class="column one-sixth">                 
                        <label><?php _e('Post per page', 'lms');?></label>
                    </div>
                    <div class="column five-sixth last">   
                        ...
                        <p class="note"> <?php _e("Your portfolio pages show at most selected number of posts per page.", 'lms');?> </p>
                    </div>
                </div><!-- Post Count End-->

                <div class="custom-box">
                    <div class="column one-sixth">                
                        <label><?php _e('Allow Filters', 'lms');?></label>
                    </div>
                    <div class="column five-sixth last">                       
                        ...
                        <p class="note"> <?php _e('Allow filter options for portfolio items', 'lms');?> </p>
                    </div>
                </div>
                
                <!-- Categories -->
                <div class="custom-box">
                    <h3><?php _e('Choose Categories', 'lms');?></h3>
                    ...
                    <p class="note"> <?php _e("You can choose only certain categories to show in portfolio items. ", 'lms');?> </p>
                </div><!-- Categories End-->                
             ...
             <div id="tpl-courses">
                ...
                <div class="custom-box">
                    ...
                    <div class="column five-sixth last">
                        ...
                        <p class="note"> <?php _e("Choose layout style for your Courses", 'lms');?> </p>
                    </div>
                </div><!-- Post Playout End-->
                ...
                <div class="custom-box">
                    ...
                    <div class="column five-sixth last">   
                        ...
                        <p class="note"> <?php _e("Your courses pages show at most selected number of posts per page.", 'lms');?> </p>
                    </div>
                ...
                <div class="custom-box">
                    <div class="column one-sixth">                 
                        <label><?php _e('Layout Type', 'lms');?></label>
                    </div>
                    <div class="column five-sixth last">   
             ...
             <div id="tpl-classes">
                ...
                <div class="custom-box">
                    ...
                    <div class="column five-sixth last">
                        ...
                        <p class="note"> <?php _e("Choose layout style for your Classes", 'lms');?> </p>
                    </div>
                </div><!-- Post Playout End-->
                ...
                <div class="custom-box">
                    ...
                    <div class="column five-sixth last">   
                        ...
                        <p class="note"> <?php _e("Your classes pages show at most selected number of posts per page.", 'lms');?> </p>
                    </div>
...
<?php  wp_reset_postdata();
    ...
    function page_meta_save($post_id, $post){
        ...
        if ( defined('DOING_AUTOSAVE') && DOING_AUTOSAVE )  return $post_id;
            ...
            if(isset($pagetemplate) && ( 'default' == $pagetemplate)  || 'tpl-sitemap.php' == $pagetemplate || 'tpl-landingpage.php' == $pagetemplate
            || 'tpl-home.php' == $pagetemplate || 'tpl-feature.php' ==  $pagetemplate || 'tpl-course-search.php' == $pagetemplate || 'tpl-fullwidth.php' == $pagetemplate ) :
            ...
            elseif( "tpl-login.php" == $pagetemplate ):
                $settings['show_slider'] =  $_POST['mytheme-show-slider'];
                $settings['slider_type'] = $_POST['mytheme-slider-type'];
                $settings['slider-image'] = $_POST['slider-image'];
                $settings['slider-shortcode'] = $_POST['slider-shortcode'];
            ...
            elseif( "tpl-blog.php" == $pagetemplate ):
            ...
            elseif( "tpl-courses.php" == $pagetemplate ):
            ...
            elseif( "tpl-classes.php" == $pagetemplate ):
