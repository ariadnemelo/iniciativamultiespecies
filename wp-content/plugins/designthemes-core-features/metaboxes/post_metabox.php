...
<?php function post_metabox(){
			add_meta_box("post-template-meta-container", __('Post Options', 'lms'), "post_settings","post", "normal", "default");
            add_meta_box("post-format-meta-container",__('Post Format Options', 'lms'),"post_format_settings","post","normal","default");
	...
	function post_settings($args){ 
        ...
        <div class="custom-box">
			<div class="column one-sixth">                        
                <label><?php _e('Disable Comments', 'lms');?></label>
            </div>
			<div class="column five-sixth last">  
                ...
                <p class="note"> <?php _e('YES! to disable Comments.', 'lms');?> </p>
            </div>	
        ...
        <div class="custom-box">
			<div class="column one-sixth">                        
        	    <label><?php _e('Disable Featured Image', 'lms');?></label>
            </div>
			<div class="column five-sixth last">  
                ...
                <p class="note"> <?php _e('YES! to disable featured image', 'lms');?> </p>
            </div>
        ...
        <div class="custom-box">
            ...
            <?php $post_meta = array(array(
                ...
                array(
                    ...
                    "label"=>	__("Disable the comment info.", 'lms'),
                    "tooltip"=>	__("By default the comment info will display when viewing your posts. You can choose to disable it here.", 'lms')
                ),
                array(
                    "id"=>		"disable-category-info",
                    "label"=>	__("Disable the category info.", 'lms'),
                    "tooltip"=>	__("By default the category info will display when viewing your posts. You can choose to disable it here.", 'lms')
                ),
                array(
                    "id"=>		"disable-tag-info",
                    "label"=>	__("Disable the tag info.", 'lms'),
                    "tooltip"=>	__("By default the tag info will display when viewing your posts. You can choose to disable it here.", 'lms')
                ));
            $count = 1;
...
<?php
    ...
    function post_format_settings( $args ) {
        ...
        <div id="dt-post-format-gallery">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php _e('Image Gallery', 'lms');?> </label></div>
                <div class="column five-sixth last">
                    <div class="dt-media-btns-container">
                        <a href="#" class="dt-open-media-for-gallery-post custom-button-style">
                            <?php _e( 'Click Here to Add Images', 'lms' );?> </a>
                    </div>
                    <div class="clear"></div>
        ...
        <div id="dt-post-format-video-audio">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php _e('oEmbed URL', 'lms');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php _e("Enter a URL that is compatible with WP's built-in oEmbed feature. This setting is used for your video and audio post formats.", 'lms');?></p>
                </div>
            </div>

            <div class="custom-box">
                <div class="column one-sixth"><label><?php _e('Self Hosted URL', 'lms');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php _e("Insert your self hosted video or audio url here.", 'lms');?></p>                    
                </div>
            </div>            
        </div>
